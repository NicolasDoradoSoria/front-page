...
function AboutUs() {
  ...
  return (
    <div id='AboutUs' className="Contenedor flex flex-col justify-center gap-7 pb-10 pt-10 bg-gradient-to-r from-purple-400 to-purple-900">
      ...
      <div className="Tarjetas flex flex-row flex-wrap justify-center gap-5">
        {Equipo.map((member, index) => (
          <Card key={index} className='pt-5 pb-10 w-1/6 min-w-fit flex justify-center items-center bg-white'>
            <Image className='w-[100px]' src={member.img} alt="" />
            <h3 className='text-black font-semibold'>{member.name}</h3>
            <span className='text-black font-light pb-3'>{member.job}</span>
