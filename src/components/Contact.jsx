...
function Contact() {
  return (
    <div className="Container bg-purple-900 h-fit flex flex-wrap justify-center z-100">
      <div className="Presupuesto basis-1/2 py-5 px-1 flex flex-grow flex-col gap-4 z-10">
      ...
      <div className="Informacion basis-1/2 flex-col flex justify-center items-center p-5 gap-5 m-w-fit z-10">
