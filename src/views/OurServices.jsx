...
function OurServices() {
  return (
    <Motion idMotion={"OurServices"} style={"GrillaServicios grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 z-10 font-normal text-md md:text-2xl text-white text-center"}>
